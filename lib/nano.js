...
(function() {
  ...
  NanoAdapter = (function() {
    ...
    NanoAdapter.prototype.all = function(model, filter, callback) {
      var designName, doClientSideProcessing, params, propName, props, value, viewName, where,
        _this = this;
      params = {
      ...
      doClientSideProcessing = !filter || filter.order || filter.where;
      ...
      return this.db.view(designName, viewName, params, function(err, body) {
        ...
        if (doClientSideProcessing) {
          ...
          if (doClientSideProcessing) {
            if (filter != null ? filter.offset : void 0) {
